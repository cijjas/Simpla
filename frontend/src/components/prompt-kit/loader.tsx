...
export function TextShimmerLoader({
  ...
  return (
    <div
      className={cn(
        "bg-[linear-gradient(to_right,color-mix(in_oklch,var(--foreground)_50%,transparent)_40%,var(--foreground)_60%,color-mix(in_oklch,var(--foreground)_50%,transparent)_80%)]",
