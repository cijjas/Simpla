            ...
            <div className="relative h-24 overflow-hidden flex-shrink-0">
              {norma.texto_resumido && (
                <>
                  ...
                  {/* fade */}
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 h-10 bg-gradient-to-t from-card via-card/80 to-transparent group-hover:from-accent group-hover:via-accent/80 transition-colors" />
                </>
              )}
            </div>
          </div>
